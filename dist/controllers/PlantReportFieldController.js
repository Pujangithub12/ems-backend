...
exports.PlantReportFieldController = void 0;
const prisma_1 = require("../config/prisma");
const VALID_DATA_TYPES = ["text", "number", "date", "boolean"];
...
class PlantReportFieldController {
    ...
    static list = async (req, res) => {
        try {
            ...
            const fields = await prisma_1.prisma.plantReportCustomField.findMany({
    ...
    static create = async (req, res) => {
        ...
        try {
            const organizationId = req.organization.id;
            const count = await prisma_1.prisma.plantReportCustomField.count({ where: { organizationId } });
            const field = await prisma_1.prisma.plantReportCustomField.create({
    ...
    static update = async (req, res) => {
        ...
        try {
            ...
            const updated = await prisma_1.prisma.plantReportCustomField.update({
                where: { id: fieldId },
    ...
    static remove = async (req, res) => {
        ...
        try {
            ...
            if (!existing)
                return res.status(404).json({ message: "Field not found" });
            await prisma_1.prisma.plantReportCustomField.delete({ where: { id: fieldId } });
...
exports.PlantReportFieldController = PlantReportFieldController;
//# sourceMappingURL=PlantReportFieldController.js.map